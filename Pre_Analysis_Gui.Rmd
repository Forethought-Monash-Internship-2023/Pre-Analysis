...
## IG_post_date Total Number Analysis
...
## IG_post_date Number of Different Brands
...
## FB_post_date Total Number Analysis
...
## FB_post_date Number of Different Brands
...
library(tidygraph)
library(ggraph)
IG_bigram_graph <- IG_com_bigrams %>%
  top_n(60) %>%
...
ggraph(IG_bigram_graph, layout = "fr") +
  ...
  geom_node_point(color = "purple1", size = 1.2) +
